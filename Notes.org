...
*** TODO Go over group selection and initial requirements for group project
    + Full requirements
    + Full design
...
**** Separate group by requirements
     ...
     + Each person submits:
       ...
       - Class diagrams
       - Activity diagrams
**** TODO Come up with interview questions based on requirements. Interview on Monday.
*** Essence of Practice
**** Polya Suggests
...
***** Should we integrate/optimize the functionality of CatCouse/DegreeWorks?
**** Question Priority
***** Necessary
